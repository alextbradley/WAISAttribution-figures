% Make supplementary figure D of the manuscript showing:
...
% (Note that these plots are produced individually and then assembled using
...
%% Make plot 6: l(M)
sigma_mu = 0.2; %single values now
sigma_m = 10;  
